...
% --- Выполняется перед тем, как номерной знак становится видимым.
...
% Эта функция не имеет выходных аргументов см. OutputFcn. 
% HObject справиться с рисунком 
% EVENTDATA защищены - должны быть определены в будущей версии MATLAB 
% Обрабатывает структуру с ручками и пользовательских данных (см. GUIDATA) 
% Varargin аргументы командной строки для licenseplate (см. VARARGIN)
